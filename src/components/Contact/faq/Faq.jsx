...
const faqs = [
  ...
  },
  {
    ...
    answer: "At Lovely Looks, pedicure services start at just ₹600. Enjoy the expertise of our professionals who provide top-quality care to keep your feet looking and feeling their best. Visit us for a relaxing and rejuvenating pedicure experience.",
  },
  {
    question: "What are the bridal makeup packages available?",
    answer: "At Lovely Looks, the Bridal Package starts at ₹5999. Let our experts pamper you with top-tier beauty treatments to make you look stunning on your special day. Experience a comprehensive bridal makeover tailored to enhance your natural beauty.",
  },
  {
  ...
  },
  {
    ...
    answer: "At Lovely Looks, a hair wash and blow-dry for women starts at ₹500. Enjoy the expertise of our professional stylists for a refreshing and stylish look. Visit us for a premium hair care experience tailored to your style.",
  },
  {
    question: "How much does waxing cost?",
    answer: "At Lovely Looks, waxing services start at just ₹240. Experience smooth and flawless skin with the expertise of our professionals. Visit us for a premium waxing experience tailored to your needs.",
  },
  {
    question: "Pricing for hair spa Treatment?",
    answer: "At Lovely Looks, our hair spa treatments start at ₹1500. Experience the expertise of our hairstylists and the benefits of premium quality products. Indulge in a luxurious session that revitalizes and nourishes your hair.",
  },
  {
    question: "How much you will charge for deep U cut for women?",
    answer: "At Lovely Looks, the cost of a deep U-cut for women starts at just ₹400. Let our expert hairstylists transform your hair with precision and style. Experience the perfect blend of creativity and skill to achieve a look that's uniquely yours. Visit us today for a premium haircut experience.",
  },
  {
  ...
  },
  {
    ...
    answer: "At Lovely Looks, expert stylists use premium products for our hair coloring services, which start from ₹1,000. Achieve vibrant and personalized color with the assurance of professional expertise and top-quality products.",
  },
  {
  ...
  },
  {
    ...
    answer: "At Lovely Looks, a stylish and expertly crafted layer cut starts at just ₹1,000. Our professional stylists ensure you get the perfect look tailored to your unique style.",
  },
  {
    question: "How much does it cost for facial?",
    answer: "At Lovely Looks, the cost for a facial starts at just ₹199. We use high-quality premium products and our services are provided by experienced experts.",
  },
  {
      ...
      <div className={styles.faqGroup}>
        {faqs.map((faq, index) => (
          <div key={index} className={styles.faqItem}>
            <div className={styles.faqTitle} onClick={() => handleToggle(index)}>
              <h5 className={styles.faqSubHeading}>
                <span className={styles.faqText}>{faq.question}</span>
                <strong className={styles.faqIcon}>
                  {activeIndex === index ? '-' : '+'}
                </strong>
              </h5>
            </div>
